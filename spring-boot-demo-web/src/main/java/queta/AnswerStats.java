...
public class AnswerStats {
	...
	private String classModeAll;
	private String classModeP1;
	private String classModeP2;
	private String classModeP3;
	private String classModeP4;
	private String classModeP5;	
	...
	public AnswerStats(int amountTot, int amountP1, int amountP2, int amountP3, int amountP4, int amountP5,
			...
			double mediP1, double mediP2, double mediP3, double mediP4, double mediP5, String classModeAll,
			String classModeP1, String classModeP2, String classModeP3, String classModeP4, String classModeP5,
			double modeAll, double modeP1, double modeP2, double modeP3, double modeP4, double modeP5, int class1Tot,
			int class1p1, int class1p2, int class1p3, int class1p4, int class1p5, int class2Tot, int class2p1,
			int class2p2, int class2p3, int class2p4, int class2p5, int class3Tot, int class3p1, int class3p2,
			int class3p3, int class3p4, int class3p5, int class4Tot, int class4p1, int class4p2, int class4p3,
			int class4p4, int class4p5, int class5Tot, int class5p1, int class5p2, int class5p3, int class5p4,
			int class5p5) {
		super();
		...
		this.mediP4 = mediP4;
		this.mediP5 = mediP5;
		this.classModeAll = classModeAll;
		this.classModeP1 = classModeP1;
		this.classModeP2 = classModeP2;
		this.classModeP3 = classModeP3;
		this.classModeP4 = classModeP4;
		this.classModeP5 = classModeP5;
	...
	public String getClassModeAll() {
		return classModeAll;
	}
	public void setClassModeAll(String classModeAll) {
		this.classModeAll = classModeAll;
	}
	public String getClassModeP1() {
		return classModeP1;
	}
	public void setClassModeP1(String classModeP1) {
		this.classModeP1 = classModeP1;
	}
	public String getClassModeP2() {
		return classModeP2;
	}
	public void setClassModeP2(String classModeP2) {
		this.classModeP2 = classModeP2;
	}
	public String getClassModeP3() {
		return classModeP3;
	}
	public void setClassModeP3(String classModeP3) {
		this.classModeP3 = classModeP3;
	}
	public String getClassModeP4() {
		return classModeP4;
	}
	public void setClassModeP4(String classModeP4) {
		this.classModeP4 = classModeP4;
	}
	public String getClassModeP5() {
		return classModeP5;
	}
	public void setClassModeP5(String classModeP5) {
		this.classModeP5 = classModeP5;
	}
