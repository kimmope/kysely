...
document.getElementById("input-tools").innerHTML = 
	`<#if uQ.colHead1??><div input id='columnLabel1'>${uQ.colHead1}</div></#if>
	<#if uQ.colHead2??><div input id='columnLabel2'>${uQ.colHead2}</div></#if>
	<#if uQ.colHead3??><div input id='columnLabel3'>${uQ.colHead3}</div></#if>
	<#if uQ.colHead4??><div input id='columnLabel4'>${uQ.colHead4}</div></#if>
	<#if uQ.colHead5??><div input id='columnLabel5'>${uQ.colHead5}</div></#if>
	<#if uQ.rowHead1??><div id='rowLabel'>${uQ.rowHead1}</div></#if>
	<input class='inputRadio' type='radio' name='answer' <#if uQ.defVal1??>value='${uQ.defVal1}'</#if>>`;
